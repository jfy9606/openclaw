...
declare const KeyboardEvent: new (type: string, init: Record<string, unknown>) => unknown;
declare const window: { location: { href: string; pathname: string } };
  ...
  async chatCompletions(params: {
    ...
    const evalPromise = this.page.evaluate(
      async ({
        ...
        parentResponseId: reqParentResponseId,
        message: reqMessage,
      }: {
        conversationId?: string;
        parentResponseId?: string;
        ...
        const parentId = reqParentResponseId;
